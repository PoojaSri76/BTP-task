...
sap.ui.require(
  [
    ...
    "expenseclaim/test/integration/ExpenseClaimListJourney",
    "expenseclaim/test/integration/ExpenseClaimObjectPageJourney",
    "expenseclaim/test/integration/ExpenseItemObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
